      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 pt-16 md:pt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-jet-black/5 border border-jet-black/5 mb-6">
          <div className="bg-pure-white flex flex-col items-center justify-center p-12 text-center">
            ...
            <p className="font-sans text-sm text-jet-black/70 leading-relaxed">+91 98464 59601</p>
          </div>
          <div className="bg-pure-white flex flex-col items-center justify-center p-12 text-center">
            <div className="w-12 h-12 rounded-full border border-jet-black/10 flex items-center justify-center mb-6 text-jet-black/70">
            ...
            <h4 className="font-sans text-sm font-bold text-jet-black mb-3">Headquarters</h4>
            <p className="font-sans text-sm text-jet-black/70 leading-relaxed max-w-[200px] mx-auto">Sruthika building, asramam lane,<br />kaloor, kochi</p>
          </div>
          <div className="bg-pure-white flex flex-col items-center justify-center p-12 text-center">
            <div className="w-12 h-12 rounded-full border border-jet-black/10 flex items-center justify-center mb-6 text-jet-black/70">
            ...
            <p className="font-sans text-sm text-jet-black/70 leading-relaxed">care@cocoman.store</p>
          </div>
        </div>
